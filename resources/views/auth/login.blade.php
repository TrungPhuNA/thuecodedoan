...
<head>
    ...
    <link rel="stylesheet" href="https://doan.previewcode.net/vendor/bootstrap/css/bootstrap.min.css">
    <link rel="shortcut icon" href="https://doan.previewcode.net/img/favicon.png">
    <style>
        .login,
        .image {
            min-height: 100vh;
